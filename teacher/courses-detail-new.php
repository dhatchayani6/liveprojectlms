...
<head>
    ...
    <style>
        /* ======================================= */
        /* STRICTLY SCOPED STYLES — WON’T AFFECT ANYTHING OUTSIDE */
        /* ======================================= */
        .co-sorter-wrapper {
        ...
        .co-sorter-wrapper .co-list {
            list-style-type: none;
            padding: 0;
            margin: 0;
        }

        .co-sorter-wrapper .co-item {
            display: flex;
        ...
        .co-sorter-wrapper .co-item:hover {
            background: #f1f8ff;
            transform: translateY(-1px);
        }

        .co-sorter-wrapper .co-badge {
            background: #e7f1ff;
            color: #0d6efd;
            border-radius: 6px;
            padding: 4px 8px;
        ...
        .co-sorter-wrapper .co-controls {
            display: flex;
            flex-direction: column;
            gap: 4px;
        }

        .co-sorter-wrapper .co-btn {
            background: none;
            border: 1px solid #ddd;
            cursor: pointer;
            border-radius: 5px;
        ...
        .co-sorter-wrapper .co-btn:hover {
            background: #f0f0f0;
            transform: scale(1.05);
        }

        .co-sorter-wrapper .material-icons {
            font-size: 18px;
            color: #444;
        }
...
<body>
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="tab-pane fade show active" id="overview" role="tabpanel"
                                ...
                                <div class="courses-outer p-3">
                                    ...
                                    <div class="border rounded mb-3">
                                        <!-- Header -->
                                        <div class="bg-secondary text-dark p-3 rounded-top d-flex align-items-center mb-3 justify-content-between">
                                            <h5 class="mb-0" style="font-size: 1rem;">Learning Outcomes & Mappings</h5>
                                            <button id="addOutcomeBtnOverview" class="btn add-outcome-btn btn-sm"><i
                                        ...
                                        <div class="p-3">
                                            ...
                                            <div id="createOutcomeFormOverview" class="p-2">
                                                <div class="bg-secondary text-dark p-3 rounded-top">
                                                    ...
                                                    <form id="frmCreateOutcome" autocomplete="off" onsubmit="return false;">
                                                        <div class="row">
                                                            <div class="col-12 mb-3">
                                                                <label for="outcomeTitle" class="form-label">CO Level</label>
                                                                <input type="text" class="form-control" id="outcomeTitleOverview" name="outcome_title" placeholder="Enter the Course Outcome Level" required>
                                                            </div>

                                                            <div class="col-12 mb-3">
                                                                <label for="courseoutcomeDescription" class="form-label">Outcome Description</label>
                                                                <textarea class="form-control" id="courseoutcomeDescriptionOverview" name="course_description" rows="4" placeholder="Enter the outcome description" required></textarea>
                                                            </div>

                                                            <div class="col-6 mb-3">
                                                                <label for="poLevel" class="form-label">PO Level</label>
                                                                <select class="form-select" id="poLevelOverview" name="po_level" required>
                                                            ...
                                                            <div class="col-6 mb-3">
                                                                ...
                                                                <select class="form-select" id="poMapOverview" name="po_Map" required>
                                                            ...
                                                            <div class="col-12 mb-3">
                                                                ...
                                                                <input readonly type="hidden" class="form-control" id="poDescriptionOverview" name="po_description" rows="4" placeholder="PO Description" required></textarea>
                                                            </div>
                                                        </div>

                                                        <div class="p-2">
                                                            <div class="d-flex justify-content-end gap-2">
                                                                <button type="button" class="btn btn-secondary rounded" id="btnCancelOutcomeOverview">Cancel</button>
                                                                <button type="button" class="btn btn-primary rounded" id="btnCreateOutcomeOverview">Create Outcome</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                            ...
                                            <div class="co-sorter-wrapper mb-3">
                                                <h6 class="co-title">Course Outcomes (COs)</h6>
                                                <ul id="coList" class="co-list">
                                                    <li class="co-item">
                                                        <span class="co-badge">CO1</span>
                                                        <span class="co-text">Define and explain key concepts in data science</span>
                                                        <div class="co-controls">
                                                            <button class="co-btn up"><span class="material-icons">arrow_upward</span></button>
                                                            <button class="co-btn down"><span class="material-icons">arrow_downward</span></button>
                                                        </div>
                                                    </li>
                                                    <li class="co-item">
                                                        <span class="co-badge">CO2</span>
                                                        <span class="co-text">Apply appropriate data collection and preprocessing techniques</span>
                                                        <div class="co-controls">
                                                            <button class="co-btn up"><span class="material-icons">arrow_upward</span></button>
                                                            <button class="co-btn down"><span class="material-icons">arrow_downward</span></button>
                                                        </div>
                                                    ...
                                                    <li class="co-item">
                                                        ...
                                                        <span class="co-text">Perform exploratory data analysis using statistical methods</span>
                                                        <div class="co-controls">
                                                            <button class="co-btn up"><span class="material-icons">arrow_upward</span></button>
                                                            <button class="co-btn down"><span class="material-icons">arrow_downward</span></button>
                                                        </div>
                                                    ...
                                                    <li class="co-item">
                                                        ...
                                                        <span class="co-text">Develop and evaluate basic machine learning models</span>
                                                        <div class="co-controls">
                                                            <button class="co-btn up"><span class="material-icons">arrow_upward</span></button>
                                                            <button class="co-btn down"><span class="material-icons">arrow_downward</span></button>
                                                        </div>
                                                    ...
                                                    <li class="co-item">
                                                        ...
                                                        <span class="co-text">Communicate insights derived from data analysis effectively</span>
                                                        <div class="co-controls">
                                                            <button class="co-btn up"><span class="material-icons">arrow_upward</span></button>
                                                            <button class="co-btn down"><span class="material-icons">arrow_downward</span></button>
                                                        </div>
                                            ...
                                            <div id="courseTopicsSection">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <h6>Course Topics</h6>
                                                    <button class="add-topic-btn-overview"><i class="bi bi-plus"></i> Add Topic</button>
                                                </div>

                                                <!-- Create New Topic Form -->
                                                <div id="createTopicFormoverview" class="p-2">
                                                    <div class="bg-secondary text-dark p-3 rounded-top">
                                                        <h5 class="mb-0" style="font-size: 1rem;">Create New Topic</h5>
                                                    </div>

                                                    <div class="p-3 border rounded">
                                                        <form id="topicFormoverview">
                                                            <div class="row">
                                                                <div class="col-12 mb-3">
                                                                    <label for="topicTitle" class="form-label">Topic Title</label>
                                                                    <input type="text" class="form-control" id="topicTitleoverview" name="topic_title"
                                                                        placeholder="Enter the topic title" required>
                                                                </div>

                                                                <div class="col-12 mb-3">
                                                                    <label for="topicDescription" class="form-label">Topic Description</label>
                                                                    <textarea class="form-control" id="topicDescriptionoverview" name="topic_description" rows="4"
                                                            ...
                                                            <div class="p-2">
                                                                <div class="d-flex justify-content-end gap-2">
                                                                    <button type="button" class="cancel-btn-overview btn btn-secondary rounded">Cancel</button>
                                                                    <button type="submit" class="create-btn-overview btn btn-primary rounded">Create Topic</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                                ...
                                                <!-- Topic Cards -->
                                                <div class="p-3" id="topicContaineroverview">
                                                    <div class="topic-card-overview rounded border p-4 mb-3"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const list = document.querySelector(".co-sorter-wrapper .co-list");
            ...
            list.addEventListener("click", function(e) {
                ...
                const currentText = li.querySelector(".co-text").textContent;

                if (btn.classList.contains("up")) {
                    const prev = li.previousElementSibling;
                    if (prev) {
                        const prevText = prev.querySelector(".co-text").textContent;
                        // swap only the text
                        prev.querySelector(".co-text").textContent = currentText;
                        li.querySelector(".co-text").textContent = prevText;
                    }
                } else if (btn.classList.contains("down")) {
                    const next = li.nextElementSibling;
                    if (next) {
                        const nextText = next.querySelector(".co-text").textContent;
                        // swap only the text
                        next.querySelector(".co-text").textContent = currentText;
                        li.querySelector(".co-text").textContent = nextText;
                    }
                }
            });
        });
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const list = document.querySelector(".course-outcomes-sorter .cos-list");
            ...
            list.addEventListener("click", function(e) {
                if (e.target.closest("button")) {
                    ...
                    if (btn.classList.contains("cos-up")) {
                        const prev = li.previousElementSibling;
                        if (prev) list.insertBefore(li, prev);
                    } else if (btn.classList.contains("cos-down")) {
                        const next = li.nextElementSibling;
                        if (next) list.insertBefore(next, li);
                    }

                    // Update CO numbering dynamically
                    [...list.children].forEach((item, index) => {
                        item.querySelector(".cos-badge").textContent = `CO${index + 1}`;
                    });
                }
            });
        });
