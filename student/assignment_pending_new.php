                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.status === 200) {
                            ...
                            // 🔥 Build shared progress data for all three API calls
                            const progressData = {
                            ...
                            // ------------------------------
                            // 1️⃣ update_material_progress.php
                            // ------------------------------
                            fetch("api/update_material_progress.php", {
                                ...
                                .then(r => r.json())
                                .then(mp => {
                                    console.log("Material Progress Updated:", mp);

                                    // ------------------------------
                                    // 2️⃣ update_topic_progress.php
                                    // ------------------------------
                                    return fetch("api/update_topic_progress.php", {
                                        method: "POST",
                                        headers: {
                                ...
                                .then(r => r.json())
                                .then(tp => {
                                    console.log("Topic Progress Updated:", tp);

                                    // ------------------------------
                                    // 3️⃣ update_course_progress.php
                                    // ------------------------------
                                    return fetch("api/update_course_progress.php", {
                                        method: "POST",
                                        headers: {
                                            "Content-Type": "application/x-www-form-urlencoded"
                                        },
                                ...
                                .then(r => r.json())
                                .then(cp => {
                                    console.log("Course Progress Updated:", cp);

                                    // ------------------------------
                                    // 4️⃣ Redirect After All Success
                                    // ------------------------------
